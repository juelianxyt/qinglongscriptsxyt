...
def update():
    ...
    try:
        r1 = requests.get("https://gitee.com/lstcml/qinglongscripts/raw/master/nwct.py").text
        ...
        if float(r2) > version:
            ...
            os.system("ql raw https://gitee.com/lstcml/qinglongscripts/raw/master/nwct.py &")
    except:
        pass
...
def download_ngrok():
    if not os.path.exists("ngrok.py"):
        res = requests.get("https://gitee.com/lstcml/qinglongscripts/raw/master/ngrok.py")
